...
class NQLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int, per_weight=None):
        ...
        mask_rewards = batch["mask_reward"]
        ...
        loss1 = L_td = masked_td_error.sum() / mask.sum()

        mask_rewards_ep = mask_rewards.sum() / batch.batch_size
        chosen_action_qvals_ep = chosen_action_qvals.sum() / batch.batch_size
        loss2 = 0.25 * (self.J_PI - mask_rewards_ep - chosen_action_qvals_ep).pow(2)
